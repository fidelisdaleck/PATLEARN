...
//         </h1>
//         <p className="text-[#444444] text-xl">Decouvrez nos fonctionalités multiples pour un apprentissage complet.</p>
//       </section>

//       {/* FONCTIONALITES */}
//       <section>
//         <div className="grid md:grid-cols-3 grid-cols-1 gap-10 mt-15 px-5 md:px-20">
//           <Card2
...
//           <h1 className="text-3xl md:text-6xl text-[#1e7f43] font-semibold">Commencer à apprendre dès aujourd’hui</h1>
//           <p className="text-xl text-[#444444]">Découvrez toutes les fonctionnalités et commencez à organiser votre apprentissage.</p>
